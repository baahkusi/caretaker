    ...
    cols:[
        {
            ...
            columns:[
                ...
                {id:"cp",format:webix.i18n.numberFormat, header:"Unit CP GH&#8373;",fillspace:true, editor:"text"},
                {id:"sp",format:webix.i18n.numberFormat, header:"Unit SP GH&#8373;",fillspace:true, editor:"text"},
                {id:"amount",format:webix.i18n.numberFormat, header:["Amount GH&#8373;"],math:"[$r,cp]*[$r,order_qty]",footer:{content:"summColumn"},sort:"int",fillspace:true},
