        ...
        rows:[
            ...
            },
            {
             ...
             columns:[
                 ...
                 {header:"Total Credit Purchases Returns For Each Day",format:webix.i18n.priceFormat,id:"record",sort:"int",fillspace:2,footer:{content:"summColumn"}},
             ],
            },
            {
                view:'tabview',
        ...
        rows:[
            ...
            },
            {
             ...
             columns:[
                 ...
                 {header:"Total Credit Purchases Returns For Each Week",format:webix.i18n.priceFormat,id:"record",sort:"int",fillspace:2,footer:{content:"summColumn"}},
             ],
            },
            {
                view:'tabview',
        ...
        rows:[
            ...
            },
            {
             ...
             columns:[
                 ...
                 {header:"Total Credit Purchases Returns For Each Month",format:webix.i18n.priceFormat,id:"record",sort:"int",fillspace:3,footer:{content:"summColumn"}},
             ],
            },
            {
                view:'tabview',
    ...
    body:{
        ...
        rows:[
            ...
            },
            {
             ...
             columns:[
                 {id:"year", header:"Year",sort:"int",fillspace:1,footer:"Total Credit Purchases Returns For Period : "},
                 {header:"Total Credit Purchases Returns For Each Year",format:webix.i18n.priceFormat,id:"record",sort:"int",fillspace:2,footer:{content:"summColumn"}},
             ],
            },
            {
                view:'tabview',
