...
function run_date_dt(){
    if ($$("from_date_dt").getValue() =="" || $$("to_date_dt").getValue() =="" ) {
        ...
        if (new Date(from_date_dt)>new Date(to_date_dt)) {
            ...
            var url = "/inventory/apiv1/helpers/track/summary";
            $$("idthistory_datatable").clearAll();
...
var inventory_history_dt = {
    header:"Stock History Summary",
    body:{
        type:"space",
        rows:[
            {
                ...
                rows:[
                    {
                    	...
                    	columns:[
                            ...
                            {id:"sr", header:["Sales Returns",{content:"numberFilter"}],fillspace:2,sort:"int",format:webix.i18n.numberFormat,footer:{content:"summColumn"}},
                            {id:"dec", header:["Decrements",{content:"numberFilter"}],fillspace:2,sort:"int",format:webix.i18n.numberFormat,footer:{content:"summColumn"}},
                            {id:"sales", header:["Sales",{content:"numberFilter"}],fillspace:2,sort:"int",format:webix.i18n.numberFormat,footer:{content:"summColumn"}},
                            {id:"pr", header:["P. Returns",{content:"numberFilter"}],fillspace:2,sort:"int",format:webix.i18n.numberFormat,footer:{content:"summColumn"}},
                            {id:"end", header:["Ending Qty",{content:"numberFilter"}],fillspace:2,sort:"int",format:webix.i18n.numberFormat,footer:{content:"summColumn"}},
                    	],
                    	on:{
