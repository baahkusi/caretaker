    ...
    cols: [
        {
            ...
            columns: [
                ...
                { id: "sp",format:webix.i18n.numberFormat, editor: "text", header: ["Unit S.P.  GH&#8373;", { content: "numberFilter" }], fillspace: 2 },
                { id: "amount",format:webix.i18n.numberFormat, header: ["Sales Amount  GH&#8373;", { content: "numberFilter" }], math: "[$r,sp]*[$r,quantity]", footer: { content: "summColumn" }, sort: "int", fillspace: 3 },
