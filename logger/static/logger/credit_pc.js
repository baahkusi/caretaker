...
function run_date_credit(){
    if ($$("from_date_credit").getValue() =="" || $$("to_date_credit").getValue() =="" ) {
        ...
        if (new Date(from_date)>new Date(to_date)) {
            ...
            var url = "/logger/apiv1/helpers/credit/pc";
    ...
    cols:[
        {
            ...
            columns:[
                ...
                {id:"amount", header:["Amount","GH&#8373;"],format:webix.i18n.priceFormat,math:"[$r,cp]*[$r,quantity]",footer:{content:"summColumn"},sort:"int",fillspace:3},
