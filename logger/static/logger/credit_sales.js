    ...
    cols:[
        {
            ...
            columns:[
                ...
                {id:"amount", header:["Sales Amount  GH&#8373;",{content:"numberFilter"}],math:"[$r,sp]*[$r,quantity]",footer:{content:"summColumn"},sort:"int",format:webix.i18n.priceFormat,fillspace:3},
                {id:"cost", header:["Cost of Sales  GH&#8373;",{content:"numberFilter"}],math:"[$r,cp]*[$r,quantity]",footer:{content:"summColumn"},sort:"int",format:webix.i18n.priceFormat,fillspace:3},
                {id:"profit", header:["Profit GH&#8373;",{content:"numberFilter"}],math:"[$r,amount]-[$r,cost]",footer:{content:"summColumn"},sort:"int",format:webix.i18n.priceFormat,fillspace:3},
