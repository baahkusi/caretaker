...
function run_date_credit(){
    if ($$("from_date_credit").getValue() =="" || $$("to_date_credit").getValue() =="" ) {
        ...
        if (new Date(from_date_credit)>new Date(to_date_credit)) {
            ...
            var url = "/logger/apiv1/helpers/credit/sales";
    ...
    cols:[
        {
            ...
            columns:[
                ...
                {id:"sp",editor:"text", header:["Unit S.P.  GH&#8373;",{content:"numberFilter"}],format:webix.i18n.priceFormat,fillspace:2},
                {id:"cp",editor:"text", header:["Unit C.P.  GH&#8373;",{content:"numberFilter"}],format:webix.i18n.priceFormat,fillspace:2},
                {id:"amount", header:["Sales Amount  GH&#8373;",{content:"numberFilter"}],format:webix.i18n.priceFormat,math:"[$r,sp]*[$r,quantity]",footer:{content:"summColumn"},sort:"int",fillspace:3},
                {id:"cost", header:["Cost of Sales  GH&#8373;",{content:"numberFilter"}],format:webix.i18n.priceFormat,math:"[$r,cp]*[$r,quantity]",footer:{content:"summColumn"},sort:"int",fillspace:3},
                {id:"profit", header:["Profit GH&#8373;",{content:"numberFilter"}],format:webix.i18n.priceFormat,math:"[$r,amount]-[$r,cost]",footer:{content:"summColumn"},sort:"int",fillspace:3},
                    ...
                    webix.confirm({
						...
						callback:function(result){
                            if (result) {
                                ...
                                // console.log(id.row);
                                var url = "/pos/apiv1/delete/creditsale";
