    ...
    cols:[
        {
            ...
            columns:[
                ...
                {id:"sp",editor:"text",format:webix.i18n.priceFormat, header:["Unit S.P.  GH&#8373;",{content:"numberFilter"}],fillspace:2},
                {id:"cp",editor:"text",format:webix.i18n.priceFormat, header:["Unit C.P.  GH&#8373;",{content:"numberFilter"}],fillspace:2},
                {id:"amount",format:webix.i18n.priceFormat, header:["Sales Amount  GH&#8373;",{content:"numberFilter"}],math:"[$r,sp]*[$r,quantity]",footer:{content:"summColumn"},sort:"int",fillspace:3},
                {id:"cost",format:webix.i18n.priceFormat, header:["Cost of Sales  GH&#8373;",{content:"numberFilter"}],math:"[$r,cp]*[$r,quantity]",footer:{content:"summColumn"},sort:"int",fillspace:3},
