    ...
    cols:[
        {
            ...
            columns:[
                ...
                {id:"amount", header:["Sales Amount  GH&#8373;",{content:"numberFilter"}],math:"[$r,sp]*[$r,quantity]",format:webix.i18n.priceFormat,footer:{content:"summColumn"},sort:"int",fillspace:3},
                {id:"cost", header:["Cost of Sales  GH&#8373;",{content:"numberFilter"}],math:"[$r,cp]*[$r,quantity]",format:webix.i18n.priceFormat,footer:{content:"summColumn"},sort:"int",fillspace:3},
                {id:"profit", header:["Profit GH&#8373;",{content:"numberFilter"}],math:"[$r,amount]-[$r,cost]",format:webix.i18n.priceFormat,footer:{content:"summColumn"},sort:"int",fillspace:3},
