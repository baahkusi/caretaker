webix.i18n.locales["gh-GH"]={   //"es-ES" - the locale name, the same as the file name
  ...
  price:"GH&#8373 {obj} ",
  calendar:{
    monthFull:["January", "Febuary", "March", "April", "May", "June", "July", "Agust",
         "September", "October", "November", "December"],
    monthShort:["Jan", "Feb", "Mar", "April","May", "Jun", "Jul", "Agu", "Sep", "Oct",
         "Nov", "Dec"],
    dayFull:["Sunday", "Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday"],
    dayShort:["Sun", "Mon", "Tue", "Wed", "Thur", "Fri", "Sat"]
  },
  hours: "Hours ",
  minutes: "Minutes",
  done:"Seconds",
