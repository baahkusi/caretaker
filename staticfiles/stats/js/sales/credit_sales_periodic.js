        ...
        rows:[
            ...
            },
            {
             ...
             columns:[
                 ...
                 {header:"Total Credit Sales For Each Day",id:"record",format:webix.i18n.priceFormat,sort:"int",fillspace:2,footer:{content:"summColumn"}},
             ],
            },
            {
                view:'tabview',
        ...
        rows:[
            ...
            },
            {
             ...
             columns:[
                 ...
                 {header:"Total Credit Sales For Each Week",id:"record",format:webix.i18n.priceFormat,sort:"int",fillspace:2,footer:{content:"summColumn"}},
             ],
            },
            {
                view:'tabview',
        ...
        rows:[
            ...
            },
            {
             ...
             columns:[
                 ...
                 {header:"Total Credit Sales For Each Month",id:"record",format:webix.i18n.priceFormat,sort:"int",fillspace:3,footer:{content:"summColumn"}},
             ],
            },
            {
                view:'tabview',
    ...
    body:{
        ...
        rows:[
            ...
            },
            {
             ...
             columns:[
                 {id:"year", header:"Year",sort:"int",fillspace:1,footer:"Total Credit Sales For Period : "},
                 {header:"Total Credit Sales For Each Year",id:"record",format:webix.i18n.priceFormat,sort:"int",fillspace:2,footer:{content:"summColumn"}},
             ],
            },
            {
                view:'tabview',
