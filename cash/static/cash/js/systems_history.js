                ...
                rows:[
                    {
                    	...
                    	columns:[
                    		...
                    		{id:"init", header:["Initial Bal",{content:"numberFilter"}],fillspace:2,sort:"int",format:webix.i18n.priceFormat,footer:{content:"summColumn"}},
                            {id:"inc", header:["Increments",{content:"numberFilter"}],fillspace:2,sort:"int",format:webix.i18n.priceFormat,footer:{content:"summColumn"}},
                            {id:"sales", header:["Sales",{content:"numberFilter"}],fillspace:2,sort:"int",format:webix.i18n.priceFormat,footer:{content:"summColumn"}},
                            {id:"pr", header:["Purchases Returns",{content:"numberFilter"}],fillspace:2,sort:"int",format:webix.i18n.priceFormat,footer:{content:"summColumn"}},
                            {id:"dec", header:["Decrements",{content:"numberFilter"}],fillspace:2,sort:"int",format:webix.i18n.priceFormat,footer:{content:"summColumn"}},
                            {id:"purchases", header:["Purchases",{content:"numberFilter"}],fillspace:2,sort:"int",format:webix.i18n.priceFormat,footer:{content:"summColumn"}},
                            {id:"sr", header:["Sales Returns",{content:"numberFilter"}],fillspace:2,sort:"int",format:webix.i18n.priceFormat,footer:{content:"summColumn"}},
                            {id:"end", header:["Ending Bal",{content:"numberFilter"}],fillspace:2,sort:"int",format:webix.i18n.priceFormat,footer:{content:"summColumn"}},
                    	],
                    	on:{
